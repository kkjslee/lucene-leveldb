 ...
 */
public class LeveldbOutputStream extends IndexOutput implements Accountable {
    ...
    public LeveldbOutputStream(String name, LeveldbFileStore store, int bufferSize, boolean checksum) {
        super("LeveldbOutputStream(name=" + name + ")");
        this.name = name;
        this.store = store;
